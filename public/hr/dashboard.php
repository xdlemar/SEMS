...
/* Reuse the same stats as Admin – HR cares about the same things */
$stats = [
...
<div class="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
  <div class="grid md:grid-cols-4 gap-4">
    ...
    <div class="bg-white rounded-xl shadow-soft border p-4">
      <div class="text-sm text-slate-500">Shortcuts</div>
      <div class="mt-2 grid grid-cols-2 gap-2 text-sm">
        <a class="rounded-lg border px-3 py-2 hover:bg-slate-50" href="/sems/public/admin/employees.php">Employees</a>
        <a class="rounded-lg border px-3 py-2 hover:bg-slate-50" href="/sems/public/hr/payroll_run.php">Payroll</a>
        <a class="rounded-lg border px-3 py-2 hover:bg-slate-50" href="/sems/public/admin/cards_register.php">Register Card</a>
        <a class="rounded-lg border px-3 py-2 hover:bg-slate-50" href="/sems/public/admin/card_change.php">Change Card</a>
      </div>
    </div>
  </div>
    ...
    <div class="bg-white rounded-xl shadow-soft border p-4">
      ...
      <script>
        (function(){
          ...
          ctx.lineWidth = 2; ctx.strokeStyle = '#059669'; ctx.beginPath();
          data.forEach((pt,i)=>{
            const x = i*step;
